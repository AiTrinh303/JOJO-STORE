...
export const AuthProvider = ({ children }) => {
  const [user, setUser] = useState(null); // Ban đầu không có người dùng đăng nhập

  const login = (userData) => {
    // Thực hiện logic đăng nhập, ví dụ:
    setUser(userData); // Set thông tin người dùng sau khi đăng nhập thành công
  };

  const logout = () => {
    // Thực hiện logic đăng xuất, ví dụ:
