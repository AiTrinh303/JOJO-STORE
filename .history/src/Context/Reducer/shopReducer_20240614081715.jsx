...
// const saleCode = [{sale: 'SUMMER', discount: 0.1}, {sale: 'WINTER', discount: 0.2}, {sale: 'SPRING', discount: 0.15}];
import all_product from "../../assets/all_product";
...
export const shopReducer = (state, action) => {
    switch (action.type) {
        ...
        case "REMOVE_FROM_WISHLIST":
                return {
                    ...state,
                    wishlist: state.wishlist.filter((item) => item.itemId !== action.payload.itemId)
                };
