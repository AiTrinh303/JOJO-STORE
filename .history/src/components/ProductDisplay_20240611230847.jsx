...
const ProductDisplay = (props) => {
  ...
  return (
    <div className="flex mx-[170px] my-0">
      <div className="flex gap-4">
        <div className="flex flex-col gap-4">
          <img className="max-h-[163px] align-middle" src={product.image} alt="img1" />
          <img className="max-h-[163px] align-middle" src={product.image} alt="img2" />
          <img className="max-h-[163px] align-middle" src={product.image} alt="img3" />
          <img className="max-h-[163px] align-middle" src={product.image} alt="img4" />
        </div>
        <div className="img">
          <img className="w-[586px] h-[700px] object-cover" src={product.image} alt="img0" />
        </div>
      </div>
