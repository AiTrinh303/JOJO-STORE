    ...
    <div className="flex mx-44 my-0">
      ...
      <div className="ml-20 flex flex-col">
        ...
        <div className="flex items-center gap-2.5 mb-5">
          <button onClick={() => setQuantity(prev => (prev === 1 ? 1 : prev - 1))} className="w-[50px] h-[30px] flex items-center justify-center mb-5 cursor-pointer bg-gray-100"> - </button>
          <span className="w-[30px] h-[30px] flex items-center justify-center mb-5">{quantity}</span>
          <button onClick={() => setQuantity(prev => prev + 1)} className="w-[50px] h-[30px] flex items-center justify-center border-none mb-5 cursor-pointer bg-gray-200"> + </button>
        </div>
