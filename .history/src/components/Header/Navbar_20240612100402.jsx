      ...
      <div className="wrapper py-2 px-8 flex items-center justify-between">
        ...
        <div className="center text-3xl tracking-wide">
          ...
          <h1 className="text-blue-500 font-bold text-3xl md:text-4xl lg:text-5xl flex items-center">
            <span className="p-1 bg-gradient-to-r from-green-400 via-blue-600 to-pink-500 bg-clip-text text-transparent">JO</span>
            <span className="p-1 bg-gradient-to-r from-green-400 via-blue-700 to-pink-500 bg-clip-text text-transparent">JO</span>
