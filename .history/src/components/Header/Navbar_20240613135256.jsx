...
const Navbar = () => {
  const [open, setOpen] = useState(false);
  const { user, logout } = useContext(AuthContext); // Sử dụng AuthContext thay vì ShopContext
  const [currency, setCurrency] = useState("USD");
  const [flag, setFlag] = useState("src/assets/en.png");
            ...
            {user ? (
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  {/* Replace this with actual avatar component or image */}
                  <img src={user.avatar} alt="User Avatar" className="rounded-full w-8 h-8" />
                </div>
