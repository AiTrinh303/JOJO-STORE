        ...
        <div className="right flex items-center gap-6">
          <div className="icons flex items-center gap-4 text-gray-500 cursor-pointer">
            ...
            <div className="relative" onClick={() => setOpen(!open)}>
              ...
              <span style= {{width: '20px', height: '20px'}}className="absolute top-[-10px] right-[-10px] text-xs w-5 h-5 rounded-full bg-blue-500 text-white flex items-center justify-center">
                {getTotalCartItems()}
              </span>
            </div>
            {/* Dark Mode */}
