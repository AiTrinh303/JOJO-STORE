...
const Navbar = () => {
  ...
  const [formOpen, setFormOpen] = useState(false); // State to manage form visibility
      ...
      <div className="wrapper py-2 px-8 flex items-center justify-between">
        ...
        <div className="center text-3xl tracking-wide ">
          <Link className="link" to="/">
            <h1 className="text-blue-500 font-bold text-3xl md:text-4xl lg:text-5xl flex items-center hover:shadow-inner">
          ...
          <div className="icons flex items-center gap-4 text-gray-500 cursor-pointer">
            ...
            {userProfile ? (
              ...
              <div className="flex items-center gap-4 relative">
                <div className="relative" onClick={() => setFormOpen(!formOpen)}>
                  <img src={userProfile.avatar} alt="User Avatar" className="rounded-full w-8 h-8 cursor-pointer" />
                </div>
