...
const Slide2 = ({ image }) => {
  return (
    <div className="relative w-full flex-shrink-0">
      ...
      <div className="absolute top-44 left-100 text-gray-500 font-bold text-2xl bg-transparent p-2.5 rounded-lg">
        ...
        <button className="mt-8 flex justify-center items-center gap-3.5 w-45 h-12 rounded-full bg-blue-600 text-white text-xl font-medium absolute left-100 top-44">
          Shop now
        </button>
      </div>
    </div>
