...
<div className="w-full flex-shrink-0 relative">
  ...
  <div className="slide2 absolute top-48 left-10 text-gray-700 font-bold text-start bg-transparent py-5 px-10 rounded-2xl">
    <h2 className="text-start text-black text-2xl font-semibold">NEW ARRIVALS ONLY</h2>
    <div className="text-startflex flex-col items-center gap-5">
