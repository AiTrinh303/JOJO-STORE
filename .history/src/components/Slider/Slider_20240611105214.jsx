...
const Slider = () => {
  ...
  return (
    <div className="slider w-screen relative w-100vw h-[calc(100vh-80px)] overflow-hidden">
      <div
        className="container flex transition-transform duration-1000"
        style={{ transform: `translateX(-${currentSlide * 100}vw)` }}
      >
        {/* Slider 1 */}
        <div className="relative flex flex-col items-center justify-center w-300vw h-full">
          <img
            src={sliderImgs[0]}
            alt="Slide 1"
