...
const Slide2 = ({ image }) => {
  return (
<div className="slide relative flex flex-col justify-center items-center">
  <img src={sliderImgs[0]} alt="" className="w-full h-auto max-h-full object-cover" />
  <div className="slide1 absolute top-48 left-5 text-gray-700 font-bold text-start bg-transparent py-5 px-10 rounded-2xl">
