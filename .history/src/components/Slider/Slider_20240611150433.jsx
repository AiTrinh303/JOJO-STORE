...
const CustomSlider = () => {
  ...
  return (
    <div className="relative overflow-hidden w-full h-80vh">
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2 left-4 cursor-pointer z-10 slick-prev">
        <WestOutlinedIcon fontSize="large" />
      </div>
      <div className="absolute top-1/2 transform -translate-y-1/2 right-4 cursor-pointer z-10 slick-next">
