...
const Slider = () => {
  ...
  // Function to calculate countdown time in seconds
  ...
  return (
    <div className="slider relative w-screen h-[calc(100vh-80px)] overflow-hidden">
      <div
        className="container flex transition-transform duration-1000"
        style={{ transform: `translateX(-${currentSlide * 100}vw)`, width: `${sliderImgs.length * 100}vw` }}
      >
        {/* Slider 1 */}
        <div className="slide w-screen h-full relative flex flex-col items-center justify-center">
          <img
            src={sliderImgs[0]}
            alt="Slide 1"
            className="w-full h-full object-cover"
          />
          <div className="slide1 text-lg font-bold bg-transparent p-4 rounded-md">
        ...
        <div className="slide w-screen h-full relative flex flex-col items-center justify-center">
          <img
            ...
            className="w-full h-full object-cover"
          />
          <div className="slide2 absolute top-[180px] left-5 text-gray-700 text-lg font-bold bg-transparent p-4 rounded-md">
