  ...
  return (
    <div className="flex mx-44 my-0">
      ...
      <div className="ml-20 flex flex-col">
        ...
        <button className="px-7 py-4 w-52 text-lg font-semibold text-white bg-blue-500 my-3.5 border-none outline-none cursor-pointer" onClick={handleCheckout}>ADD TO CART</button>
