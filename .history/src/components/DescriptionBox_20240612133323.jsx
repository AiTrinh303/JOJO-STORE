...
const DescriptionBox = () => {
  return (
    <div className='mt-40 mx-28'>
      <div className="flex">
        <div className="flex items-center justify-center text-lg font-semibold w-[171px] h-[70px] border border-[#d0d0d0]">
          Description
        </div>
        <div className="flex items-center justify-center text-lg font-semibold w-[171px] h-[70px] border border-[#d0d0d0] bg-[#FBFBFB] text-[#555]">
          Reviews (303)
        </div>
      </div>
