    ...
    <div className="flex mx-44 my-0">
      <div className="flex gap-4">
        <div className="flex flex-col gap-4">
          <img className="max-h-44 align-middle" src={product.image} alt="img1" />
          <img className="max-h-44 align-middle" src={product.image} alt="img2" />
          <img className="max-h-44 align-middle" src={product.image} alt="img3" />
          <img className="max-h-44 align-middle" src={product.image} alt="img4" />
        </div>
        <div className="img">
          <img style= {{height: '768px', width: '586px'}} className="object-cover" src={product.image} alt="img0" />
        </div>
      </div>
