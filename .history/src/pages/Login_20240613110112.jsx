...
import { useAuth,  loginAction } from "../Context/AuthContext";
    ...
    <>  
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="max-w-md w-full bg-white p-8 border border-gray-300 rounded-lg shadow-md">
          ...
          <form className="py-6" onSubmit={handleSubmitEvent}>

            <div className="mb-4">
              <label htmlFor="user-email" className="block text-gray-700 font-semibold mb-3">Email:</label>
              <input
                type="email"
                id="user-email"
                name="email"
