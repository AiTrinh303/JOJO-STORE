...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (input.email === "titatiton303@gmail.com" && input.password === "12345") {
      // Simulate successful login
      // Here you would typically call your authentication function
      // For demonstration, navigate to a protected page
      navigate("/dashboard"); // Example navigation to '/dashboard' on successful login
    } else {
