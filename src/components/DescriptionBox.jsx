  ...
  return (
    <div className='mt-40 mx-28'>
      <div className="flex mb-1">
        <div className="flex items-center justify-center text-xl font-semibold w-44 h-16 border border-gray-400 mr-1">
          Description
        </div>
        <div className="flex items-center justify-center text-xl font-semibold w-44 h-16 border border-gray-400 bg-[#FBFBFB] text-[#555]">
          Reviews (303)
        </div>
      </div>
