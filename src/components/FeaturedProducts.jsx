...
const FeaturedProducts = () => {
  return (
    <div className="featuredProducts container mx-auto mt-40 px-10">
      ...
      <div data-aos="zoom-out" className="bottom flex justify-center gap-10">
